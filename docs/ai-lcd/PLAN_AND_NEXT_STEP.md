...
### ✅ Actualización 2026-04-08 — Fix #151: Expired Insights Panel (Filas Expandibles)

**Estado**: COMPLETADO ✅

**Implementación**:
- [x] Reescrito `ExpiredInsightsPanel.jsx` con filas expandibles
- [x] Actualizado CSS para soportar detalles expandidos
- [x] Lazy loading de detalles (fetch solo al expandir)
- [x] Caché local para re-expansiones instantáneas
- [x] 6 secciones de información:
  - [x] Resumen del Insight (status, longitud, reintentos)
  - [x] Validación OCR (status + razón)
  - [x] Texto Original (título + contenido completo)
  - [x] Historial de Errores (timestamps + mensajes)
  - [x] Insights Generados (si existen)
  - [x] Estado del Pipeline (stage, IDs)
- [x] Frontend rebuild + redeploy

**Verificación**:
- [ ] Abrir dashboard como admin
- [ ] Verificar insights expirados visibles
- [ ] Click en fila → expandir
- [ ] Verificar 6 secciones con datos correctos
- [ ] Verificar colores distintos por sección
- [ ] Re-click → colapsar
- [ ] Expandir otra fila → caché instantáneo

**Archivos modificados**:
- `app/frontend/src/components/dashboard/ExpiredInsightsPanel.jsx` (381 líneas)
- `app/frontend/src/components/dashboard/ExpiredInsightsPanel.css` (481 líneas)

**Documentación**:
- [x] CONSOLIDATED_STATUS.md § Fix #151
- [x] SESSION_LOG.md § 2026-04-08 (Decisiones arquitectónicas)
- [ ] REQUESTS_REGISTRY.md (no aplica - mejora de UI existente)

**Próximo paso sugerido**: 
- Testing manual del panel expandible con insights reales
- Verificar performance con muchos insights expirados (>50)
